...
taxes_transfers_minus_neutral <- function(df){
  taxes = all_levels('corporate_taxes', 'non_corporate_taxes')#all_levels creates a character that has the string, 
                                                              #federal_string, state_string 
                                                              #for each string you specify 
